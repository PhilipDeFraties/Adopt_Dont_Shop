...
RSpec.describe "pets index page" do
    ...
    shadow = shelter_1.pets.create(image_path: 'cat1.jpg', name: "Shadow", approx_age: 7, sex: "Male")
    nooch = shelter_1.pets.create(image_path: "cat2.jpg", name: "Nooch", approx_age: 7, sex: "Male")
